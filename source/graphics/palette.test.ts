...
it("renders the correct HSL palettes - Size 1", () => {
	...
	assert.deepStrictEqual(
		hslPalette(1, 0, 0.5, 0.5).map(render),
		["bf3f3f"],
		"Under-saturated 0.5",
	);
	assert.deepStrictEqual(
	...
	// Darker
	assert.deepStrictEqual(
		hslPalette(1, 0, 0.25, 0.25).map(render),
		["4f2f2f"],
		"Darker 0.25 0.25",
	);
	assert.deepStrictEqual(
		hslPalette(1, 0, 0.5, 0.25).map(render),
		["5f1f1f"],
		"Darker 0.5 0.25",
	);
	assert.deepStrictEqual(
		hslPalette(1, 0, 0.75, 0.25).map(render),
		["6f0f0f"],
		"Darker 0.75 0.25",
	);
	assert.deepStrictEqual(
		hslPalette(1, 0, 1, 0.25).map(render),
		["7f0000"],
		"Darker 1 0.25",
	);
	// Lighter
	assert.deepStrictEqual(
		hslPalette(1, 0, 0.25, 0.75).map(render),
		["cfafaf"],
		"Lighter 0.25 0.75",
	);
	assert.deepStrictEqual(
		hslPalette(1, 0, 0.5, 0.75).map(render),
		["df9f9f"],
		"Lighter 0.5 0.75",
	);
	assert.deepStrictEqual(
		hslPalette(1, 0, 0.75, 0.75).map(render),
		["ef8f8f"],
		"Lighter 0.75 0.75",
	);
	assert.deepStrictEqual(
		hslPalette(1, 0, 1, 0.75).map(render),
		["ff7f7f"],
		"Lighter 1 0.75",
	);
});
