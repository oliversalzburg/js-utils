...
export class Matrix3 {
	...
	multiplyR(matrix: Readonly<Matrix3>): this {
		const z11 =
			matrix.m00 * this.m00 + matrix.m01 * this.m10 + matrix.m02 * this.m20;
		const z21 =
			matrix.m10 * this.m00 + matrix.m11 * this.m10 + matrix.m12 * this.m20;
		const z31 =
			matrix.m20 * this.m00 + matrix.m21 * this.m10 + matrix.m22 * this.m20;
		const z12 =
			matrix.m00 * this.m01 + matrix.m01 * this.m11 + matrix.m02 * this.m21;
		const z22 =
			matrix.m10 * this.m01 + matrix.m11 * this.m11 + matrix.m12 * this.m21;
		const z32 =
			matrix.m20 * this.m01 + matrix.m21 * this.m11 + matrix.m22 * this.m21;
		const z13 =
			matrix.m00 * this.m02 + matrix.m01 * this.m12 + matrix.m02 * this.m22;
		const z23 =
			matrix.m10 * this.m02 + matrix.m11 * this.m12 + matrix.m12 * this.m22;
		const z33 =
			matrix.m20 * this.m02 + matrix.m21 * this.m12 + matrix.m22 * this.m22;
		this.m00 = z11;
		this.m10 = z21;
		this.m20 = z31;
		this.m01 = z12;
	...
	multiplyInverseR(matrix: Readonly<Matrix3>): this {
		const z11 =
			matrix.m00 * this.m00 + matrix.m10 * this.m10 + matrix.m20 * this.m20;
		const z21 =
			matrix.m01 * this.m00 + matrix.m11 * this.m10 + matrix.m21 * this.m20;
		const z31 =
			matrix.m02 * this.m00 + matrix.m12 * this.m10 + matrix.m22 * this.m20;
		const z12 =
			matrix.m00 * this.m01 + matrix.m10 * this.m11 + matrix.m20 * this.m21;
		const z22 =
			matrix.m01 * this.m01 + matrix.m11 * this.m11 + matrix.m21 * this.m21;
		const z32 =
			matrix.m02 * this.m01 + matrix.m12 * this.m11 + matrix.m22 * this.m21;
		const z13 =
			matrix.m00 * this.m02 + matrix.m10 * this.m12 + matrix.m20 * this.m22;
		const z23 =
			matrix.m01 * this.m02 + matrix.m11 * this.m12 + matrix.m21 * this.m22;
		const z33 =
			matrix.m02 * this.m02 + matrix.m12 * this.m12 + matrix.m22 * this.m22;
		this.m00 = z11;
		this.m10 = z21;
		this.m20 = z31;
		this.m01 = z12;
	...
	multiplyInverseL(matrix: Readonly<Matrix3>): this {
		...
		const z21 =
			this.m10 * matrix.m00 + this.m11 * matrix.m01 + this.m12 * matrix.m02;
		const z31 =
			this.m20 * matrix.m00 + this.m21 * matrix.m01 + this.m22 * matrix.m02;
		const z12 =
			this.m00 * matrix.m10 + this.m01 * matrix.m11 + this.m02 * matrix.m12;
		const z22 =
			this.m10 * matrix.m10 + this.m11 * matrix.m11 + this.m12 * matrix.m12;
		const z32 =
			this.m20 * matrix.m10 + this.m21 * matrix.m11 + this.m22 * matrix.m12;
		const z13 =
			this.m00 * matrix.m20 + this.m01 * matrix.m21 + this.m02 * matrix.m22;
		const z23 =
			this.m10 * matrix.m20 + this.m11 * matrix.m21 + this.m12 * matrix.m22;
		const z33 =
