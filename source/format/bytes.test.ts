...
it("locale option", () => {
	...
	assert.strictEqual(
		formatBytes(-0.4, { locale: ["unknown", "de", "en"] }),
		"-0,4 B",
	);
	assert.strictEqual(
		formatBytes(0.4, { locale: ["unknown", "de", "en"] }),
	...
	assert.strictEqual(
		formatBytes(1001, { locale: ["unknown", "de", "en"] }),
		"1 kB",
	);
	assert.strictEqual(
		formatBytes(10.1, { locale: ["unknown", "de", "en"] }),
		"10,1 B",
	);
	assert.strictEqual(
		formatBytes(1e30, { locale: ["unknown", "de", "en"] }),
		"1.000.000 YB",
	);
...
it("bits and binary option", () => {
	...
	assert.strictEqual(
		formatBytes(1025, { binary: true, bits: true }),
		"1 kibit",
	);
	assert.strictEqual(
		formatBytes(1e6, { binary: true, bits: true }),
		"977 kibit",
	);
});
...
it("fractional digits options", () => {
	...
	assert.strictEqual(
		formatBytes(1111, { maximumFractionDigits: 2 }),
		"1.11 kB",
	);
	assert.strictEqual(
		formatBytes(1019, { maximumFractionDigits: 3 }),
		"1.019 kB",
	);
	assert.strictEqual(
		formatBytes(1001, { maximumFractionDigits: 3 }),
		"1.001 kB",
	);
	assert.strictEqual(
	...
	assert.strictEqual(
		formatBytes(4001, { binary: true, maximumFractionDigits: 3 }),
		"3.907 KiB",
	);
	assert.strictEqual(
		formatBytes(18_717, { binary: true, maximumFractionDigits: 2 }),
		"18.28 KiB",
	);
	assert.strictEqual(
